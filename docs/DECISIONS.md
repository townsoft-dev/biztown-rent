...
C. **(Phát hiện Thấp-Trung bình) Ngôn ngữ tin nhắn Zalo/SMS gửi Tenant chưa định nghĩa.** Chốt: **cố định cố định tiếng Anh và tiếng Việt ở Phase 1, tiếng việt bên trên tiếng anh bên dưới**, độc lập hoàn toàn với ngôn ngữ hiển thị (EN/VI/KO) của người tạo hoá đơn — Tenant không có tài khoản nên không tự chọn ngôn ngữ. Thêm `BR-NOTI-07`; cập nhật `FR-NOTI-02`, `DESIGN-SYSTEMS.md` mục 0 (ghi chú phân biệt ngôn ngữ UI tài khoản vs ngôn ngữ nội dung gửi Tenant).
