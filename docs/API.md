...
| `send-otp-sms` | Auth Hook (Send SMS) — gửi OTP qua nhà cung cấp SMS Việt Nam | Supabase Auth gọi khi **bất kỳ tài khoản nào** đăng ký/quên mật khẩu | Không đổi (không phụ thuộc schema nghiệp vụ). TODO chờ chọn eSMS/Speedsms |
