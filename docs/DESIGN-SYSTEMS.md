...
>
> **Cập nhật thêm cùng ngày 18/09/2026** — Dream gửi thêm 2 file wordmark "RENT MANAGER" **chữ đậm** (`rentmanager-wordmark-bold-white.png` / `-bold-navy.png`) và chọn dùng bản chữ đậm này thay cho bản chữ thường (`rentmanager-wordmark-white.png`) ở Splash — dễ đọc hơn trên nền navy khi đặt cạnh logo thương hiệu. Bản chữ thường vẫn giữ lại trong `design/Logo/` và `src/assets/logo/` làm tham khảo, không xoá. Dream cũng xác nhận **đã tự cập nhật file Figma** (`BizTown Rent-Manager — MVP Wireframes`) khớp với bố cục Splash 2 tầng đã đổi trong code (mục 08:12/08:43 trong `changelog/2026-09-18.md`) — mục Figma-chưa-đồng-bộ coi như đã xử lý, không còn là việc mở.
...
| [`rentmanager-wordmark-bold-white.png`](../design/Logo/rentmanager-wordmark-bold-white.png) | **Wordmark "RENT MANAGER" chữ đậm, chữ trắng (18/09/2026)** — đã copy vào `src/assets/logo/`, **đang dùng ở Splash** (dưới logo thương hiệu, trên nền navy), thay cho bản chữ thường |
| [`rentmanager-wordmark-bold-navy.png`](../design/Logo/rentmanager-wordmark-bold-navy.png) | Wordmark "RENT MANAGER" chữ đậm, màu navy — đã copy vào `src/assets/logo/` để sẵn, chưa dùng (dành cho nền sáng nếu sau này cần) |
| [`rentmanager-wordmark-white.png`](../design/Logo/rentmanager-wordmark-white.png) | Wordmark "RENT MANAGER" chữ thường, chữ trắng — **đã thay thế** ở Splash bằng bản chữ đậm ở trên, giữ tham khảo |
| [`rentmanager-wordmark-navy.png`](../design/Logo/rentmanager-wordmark-navy.png) / `-orange.png` / `-slate.png` / `-lavender.png` | Wordmark "RENT MANAGER" chữ thường, các màu khác — chưa dùng, để sẵn nếu cần trên nền sáng |
